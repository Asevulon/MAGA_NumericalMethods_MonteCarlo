...
// MAGA_NumericalMethods_MonteCarlo.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMAGANumericalMethodsMonteCarloApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMAGANumericalMethodsMonteCarloApp

CMAGANumericalMethodsMonteCarloApp::CMAGANumericalMethodsMonteCarloApp()
{
...
// Единственный объект CMAGANumericalMethodsMonteCarloApp

CMAGANumericalMethodsMonteCarloApp theApp;


// Инициализация CMAGANumericalMethodsMonteCarloApp

BOOL CMAGANumericalMethodsMonteCarloApp::InitInstance()
{
